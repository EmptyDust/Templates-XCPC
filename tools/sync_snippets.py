...
SOURCES = [
    ...
    ('geometry', 'fgcd', [('code/二维几何/预置函数.cpp', None)]),
    ('geometry', 'point', [('code/二维几何/点线封装.cpp', None)]),
    ('geometry', 'point3', [('code/三维几何及常见例题/点线面封装.cpp', None)]),
    ('geometry', 'len', [('code/三维几何及常见例题/其他函数.cpp', None)]),
    ('geometry', 'pointonsegment', [('code/三维几何及常见例题/空间点是否在线段上.cpp', None)]),
    ('geometry', 'segmentintersection', [('code/三维几何及常见例题/空间两线段是否相交.cpp', None)]),
    ('geometry', 'lineplanecross', [('code/三维几何及常见例题/直线与平面是否相交及交点.cpp', None)]),
    ('geometry', 'pointonlineleft', [('chapters/二维几何.typ', '点是否在向量直线左侧', 0)]),
    ('geometry', 'pointonlineside', [('chapters/二维几何.typ', '两点是否在直线同侧异侧', 0)]),
    ('geometry', 'lineparallel_1', [('chapters/二维几何.typ', '两直线是否平行垂直相同', 0)]),
    ('geometry', 'dispointtoline', [('chapters/二维几何.typ', '点到直线的最近距离与最近点', 1)]),
    ('geometry', 'pointonsegment_1', [('chapters/二维几何.typ', '点是否在线段上', 0)]),
    ('geometry', 'pointtosegment', [('chapters/二维几何.typ', '点到线段的最近距离与最近点', 0)]),
    ('geometry', 'midsegment', [('chapters/二维几何.typ', '线段的中垂线', 0)]),
    ('geometry', 'segmentintersection_1', [('chapters/二维几何.typ', '两线段是否相交及交点', 0)]),
    ('geometry', 'segmentintersection_2', [('chapters/二维几何.typ', '两线段是否相交及交点', 1)]),
    ('geometry', 'center1', [('chapters/二维几何.typ', '三角形外心', 0)]),
    ('geometry', 'slope', [('chapters/二维几何.typ', '浮点数计算直线的斜率', 0)]),
    ('geometry', 'slopeex', [('chapters/二维几何.typ', '分数精确计算直线的斜率', 0)]),
    ('geometry', 'getfun', [('chapters/二维几何.typ', '两点式转一般式', 0)]),
    ('geometry', 'lineintersection', [('chapters/三维几何及常见例题.typ', '空间两直线是否相交及交点')]),
    ('geometry', 'planeintersection', [('chapters/三维几何及常见例题.typ', '两平面是否相交及交线')]),
    ('geometry', 'code_3', [('chapters/三维几何及常见例题.typ', '线段将多边形切割为几个部分')]),
    ('geometry', 'halfcut', [('chapters/多边形相关.typ', '半平面交')]),
